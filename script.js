function plotPoint(x0, y0, x, y) {
    ...
    const oldPoint = document.querySelector('.point'); // selects the first element with the class 'point'
    if(oldPoint)
    {
      oldPoint.remove(); // removes the old point from the coordinate plane
    }
    ...
    plane.appendChild(point); // adds the new point to the coordinate plane
